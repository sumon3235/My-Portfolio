...
const containerVariants = {
  ...
  visible: {
    transition: {
      staggerChildren: 0.1, // Elements will show up one by one quickly
      delayChildren: 0,
    },
  },
};
...
const Banner = () => {
  return (
    <motion.section
      ...
      initial="hidden"
      animate="visible"
      className="min-h-screen flex flex-col items-center justify-center text-center px-6 bg-[#0B0F14] relative overflow-hidden py-1 lg:py-24"
    >
      {/* Background glow */}
      <div 
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-50 lg:w-72 h-50 lg:h-80 bg-[#00d4ff]/30 rounded-full blur-[150px] pointer-events-none"
      />
      ...
      >
        ...
        <motion.span
         ...
         className="text-white/20"><FaArrowDownLong size={20}/></motion.span>
